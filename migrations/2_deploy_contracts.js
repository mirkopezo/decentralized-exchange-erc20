...
module.exports = async function(deployer, _network, accounts) {
    ...
    await Promise.all([
        dex.createLimitOrder(BAT, 1400, 10, SIDE.BUY, {from: trader1, gas:3000000}),
        dex.createLimitOrder(BAT, 1200, 11, SIDE.BUY, {from: trader2, gas:3000000}),
        dex.createLimitOrder(BAT, 1000, 12, SIDE.BUY, {from: trader2, gas:3000000}),

        dex.createLimitOrder(REP, 3000, 4, SIDE.BUY, {from: trader1, gas:3000000}),
        dex.createLimitOrder(REP, 2000, 5, SIDE.BUY, {from: trader1, gas:3000000}),
        dex.createLimitOrder(REP, 500, 6, SIDE.BUY, {from: trader2, gas:3000000}),

        dex.createLimitOrder(ZRX, 4000, 12, SIDE.BUY, {from: trader1, gas:3000000}),
        dex.createLimitOrder(ZRX, 3000, 13, SIDE.BUY, {from: trader1, gas:3000000}),
        dex.createLimitOrder(ZRX, 500, 14, SIDE.BUY, {from: trader2, gas:3000000}),

        dex.createLimitOrder(BAT, 2000, 16, SIDE.SELL, {from: trader3, gas:3000000}),
        dex.createLimitOrder(BAT, 3000, 15, SIDE.SELL, {from: trader4, gas:3000000}),
        dex.createLimitOrder(BAT, 500, 14, SIDE.SELL, {from: trader4, gas:3000000}),

        dex.createLimitOrder(REP, 4000, 10, SIDE.SELL, {from: trader3, gas:3000000}),
        dex.createLimitOrder(REP, 2000, 9, SIDE.SELL, {from: trader3, gas:3000000}),
        dex.createLimitOrder(REP, 800, 8, SIDE.SELL, {from: trader4, gas:3000000}),

        dex.createLimitOrder(ZRX, 1500, 23, SIDE.SELL, {from: trader3, gas:3000000}),
        dex.createLimitOrder(ZRX, 1200, 22, SIDE.SELL, {from: trader3, gas:3000000}),
        dex.createLimitOrder(ZRX, 900, 21, SIDE.SELL, {from: trader4, gas:3000000}),
    ]);
}